...
const List<CatGroup> kCatGroups = [
  ...
  CatGroup(label: 'Основни', emoji: '🍚', slugs: ['eggs', 'bread', 'flour', 'sugar', 'rice', 'pasta', 'legumes', 'oil-sunflower', 'olive-oil']),
  CatGroup(label: 'Лакомства', emoji: '🍫', slugs: ['chocolate', 'biscuits']),
  CatGroup(label: 'Напитки', emoji: '🍷', slugs: ['coffee', 'tea', 'beer', 'wine', 'spirits', 'water', 'juice']),
  CatGroup(label: 'Дом и хигиена', emoji: '🧼', slugs: ['toilet-paper', 'wet-wipes', 'dishwash', 'home-clean', 'diapers']),
];
